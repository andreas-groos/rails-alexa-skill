...
RSpec.describe "recite recipe alexa intent", :type => :request do
  fixtures :users

  it "recites a full recipe when requested" do

    u = users(:one)

    amazon_user_id = u.amazon_user_identifier
    request_type = "IntentRequest"
    intent_name = "reciterecipe"
    ...
    expect(result['response']['outputSpeech']['text']).to include("mash")
  end
